  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.marine-project-link').on('click',function(){
      window.open("https://play.google.com/store/apps/details?id=com.OpenWorld.inwyt");
      //gsap.to('#home',.5,{scale:.9});
      //gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      //gsap.to('#home',0,{display:'none',delay:.7});
    ...
    $('.forest-project-link').on('click',function(){
      window.open("https://play.google.com/store/apps/details?id=com.openworldera.drawfend");
      //gsap.to('#home',.5,{scale:.9});
      //gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      //gsap.to('#home',0,{display:'none',delay:.7});
    ...
    $('.wildlife-project-link').on('click',function(){
      window.open("https://play.google.com/store/apps/details?id=com.openworldera.taktak");
      //gsap.to('#home',.5,{scale:.9});
      //gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      //gsap.to('#home',0,{display:'none',delay:.7});
    ...
    $('.city-project-link').on('click',function(){
      window.open("https://play.google.com/store/apps/details?id=com.openworldera.slippy");
      //gsap.to('#home',.5,{scale:.9});
      //gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      //gsap.to('#home',0,{display:'none',delay:.7});
